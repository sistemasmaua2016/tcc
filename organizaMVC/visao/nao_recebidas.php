...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Receitas não recebidas</title>
        ...
        <div id="all">
            <header>
                <div class="row" style="font-family: 'Bree Serif', serif;">
                    <div class="col-sm-6">
                        <h3>&nbsp;&nbsp;Receitas não recebida </h3>
                    </div>
                    <div class="col-sm-6 text-right h2"><table width="507" border="0" style="position: absolute; right: 4%; width: 199%; height: 10%; top: 40px;">
                            <tr><td width="89" align="right"><a class="btn btn-default" onclick="atualizaIframeren()"><i class="fa fa-refresh"></i>Atualizar</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            if ($i == 0) {
                ...
                $result = $finacasDAO->getReceitaAVencerPorData($_SESSION['id'], $pesq, $tipo = 'receita');
            ...
            <hr>
                ...
                <div id="ModalDel" class="modalDialog" style="background: rgba(0,0,0,0);">
                    <div id="mmodal2" class="divdados" style="width: 24%; height: 15%; padding: 1%  0 0 1.5%; left: 35%; top: 10%;">
                        ...
                        <form action="../Controle/ExcluirNao_Recebidas.php" id="del" method="post">
                            <input type="hidden" name="idd" id="idd" value="" />
                            <?php
                            echo 'Excluir receita?';
                            ?>
                ...
                <div id="ModalEdit" class="modalDialog" style="background: rgba(0,0,0,0);">
                    <div class="divdados" style="height: 20%;"><a href="#close" title="Close" class="close">X</a><div id="query" style="position:absolute; top: 23%; font-size:16px;"></div><div id="tab" style="visibility:hidden">
                            <form action="../Controle/AlterarNao_Recebidas.php" id="formaltdados" name="formaltdados" method="post">
                                <h2>Editar conta</h2>
                                <table>
                                    <tr>
                                        <td width="0">&nbsp;</td>
