...
?>
<div id="cancela" style="width:27%; height:32%; visibility: hidden; position:absolute; top: 50%; left: 28%" class="btn btn-danger" onclick="location.href='#close'; atualizaiframerecb()">Cancelar</div>
...
<div id="okat" style="width:20%; height:23%; position:absolute; top: 60%; left: 6.5%" class="btn btn-primary" onclick="location.href='#close'; atualizaiframerecb()">OK</div><div style="float:right">
